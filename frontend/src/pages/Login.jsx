  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        <div className="w-16 h-16 rounded-2xl bg-emerald-600 flex items-center justify-center font-extrabold text-2xl text-white mx-auto shadow-lg mb-4">
          BE
        </div>
        ...
        <p className="mt-1 text-sm text-slate-400">
          Motton Market, Jaysingpur — Billing Management System
        </p>
      </div>
