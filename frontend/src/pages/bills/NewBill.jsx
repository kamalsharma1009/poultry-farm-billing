  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleOpenConfirmModal} className="space-y-6">
        ...
        <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-xs space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200 pb-4">
            ...
            <Link
              to="/customers/new"
              target="_blank"
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-emerald-600 hover:text-emerald-800 bg-emerald-50 px-3 py-1.5 rounded-md"
            >
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs font-semibold text-slate-600">
                  {selectedCustomer.businessName} • Mobile: {selectedCustomer.mobile}
                </p>
              </div>
              <button
                type="button"
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 border border-slate-300 rounded-lg text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                />
              </div>
          ...
          <div className="pt-2">
            ...
            <input
              ...
              className="w-full sm:w-64 px-3.5 py-2 border border-slate-300 rounded-lg text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
          </div>
        </div>
        ...
        {/* Calculation Summary & Submit Section */}
        <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-xs flex flex-col lg:flex-row justify-between items-start lg:items-stretch gap-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full lg:max-w-md">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-slate-300 rounded-md text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500"
              />
            </div>
            <div>
              <label className="block text-xs font-semibold text-slate-500 mb-1">Other Charges (₹)</label>
              <input
                type="number"
                step="0.01"
                value={otherCharges}
            ...
            <div className="bg-amber-50/70 p-3 rounded-lg border border-amber-200">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full px-3 py-2 border border-amber-300 rounded-md text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-amber-500 bg-white font-semibold"
              />
              <span className="text-[10px] text-amber-700 mt-1 block">Past unpaid balance</span>
            </div>
            <div className="bg-emerald-50/70 p-3 rounded-lg border border-emerald-200">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full px-3 py-2 border border-emerald-300 rounded-md text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-white font-semibold"
              />
              <span className="text-[10px] text-emerald-700 mt-1 block">Payment received now</span>
            </div>
          </div>

          <div className="w-full lg:w-88 bg-slate-900 text-white p-6 rounded-xl space-y-2.5 flex flex-col justify-between">
            <div className="space-y-2">
              ...
              {otherChargesVal > 0 && (
                <div className="flex justify-between text-xs text-slate-300">
                  ...
                  <span>+ ₹{otherChargesVal.toFixed(2)}</span>
                </div>
              )}
              ...
              <div className="border-t border-slate-700 pt-2.5 flex justify-between items-center text-lg font-extrabold">
                <span className="text-sm uppercase tracking-wider text-slate-300">Total Amount:</span>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold rounded-lg shadow-md transition-colors disabled:opacity-50 mt-3"
            >
